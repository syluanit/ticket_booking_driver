...
public class Fragment_tim_chuyen_xe extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_tim_chuyen_xe, container, false);
...
//                Fragment_Ghe_Ngoi fragmentGheNgoi = new Fragment_Ghe_Ngoi();
//                fragmentTransaction.add(R.id.layout,fragmentGheNgoi,"ghe_ngoi");
